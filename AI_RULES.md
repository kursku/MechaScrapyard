...
> Always check `implementation_plan.md` before structural changes.
...
| `muscle` | Muscle | Power, mecha combat, heavy handling |
...
MechaScrapyard/
├── src/
│   ├── game.js              # Game loop (from Arcanum)
│   ├── gameState.js          # Central state (from Arcanum)
│   ├── techTree.js           # Unlock system (from Arcanum)
│   ├── dataLoader.js         # Data loading (from Arcanum)
│   ├── items/                # Item type classes
│   ├── chars/                # Character system (Pilot, MechaChar)
│   ├── composites/
│   │   ├── combat.js         # Adapted for d100 + mecha parts
│   │   ├── explore.js        # Adapted for districts
│   │   └── runner.js         # Task runner (from Arcanum)
│   ├── modules/
│   │   ├── runner.js
│   │   └── persist.js        # Save/load
│   ├── values/
│   │   ├── BipolarStat.js    # Morality system (NEW)
│   │   └── stat.js           # Stat class (from Arcanum)
│   ├── util/
│   │   ├── d100.js           # Roll system (NEW)
│   │   └── format.js
│   └── ui/                   # Vue 3 components
│       └── ...
├── data/
│   └── mecha/                # ALL game content here
│       ├── resources.json
│       ├── tasks.json
│       ├── upgrades.json
│       ├── blueprints.json
...
│       ├── player.json
│       ├── sections.json
│       └── modules/          # Per-district content
│           ├── downtown/
│           ├── slums/
│           ├── industrial/
│           └── ...
├── css/
│   └── mecha_terminal.css    # Terminal aesthetic
...
- **Gameplay text** (names, desc, tips): English
...
- Make structural changes without checking `implementation_plan.md`
...
*Last updated: Sprint 1.5 — v0.1.5*
*Maintained by: Charles (SB Studio)*
*Merged from: Original AI_RULES (Antigravity) + Expanded AI_RULES (Claude)*
